...
export default class Graph extends Component {
  ...
  createUnclustered() {
    ...
    websites.forEach(website => {
      ...
      if (website.active) {
        n.push({ id,color: '#E78587', label: website.title, title: content, domain: domain })
      }
      ...
      res => {
        ...
        links.forEach(link => {
          ...
          if (map1.has(child)){
            ...
            n.push({ id: linkId,title: content, label: title, domain: domain })
      ...
      <>
        ...
        >
          ...
          <DialogContent>
            ...
            {"You have successfully started an execution for website "+this.state.website.url+"."}
            </DialogContentText>
          </DialogContent>
          <DialogActions>
